# Class Diagrams Index <!-- omit in toc -->
- [Overview](#overview)
- [Directory Structure](#directory-structure)
- [Domain Layer](#domain-layer)
  - [Value Objects](#value-objects)
  - [Entities](#entities)
  - [Repositories (Traits)](#repositories-traits)
  - [Services (Traits)](#services-traits)
  - [Errors](#errors)
...
- [Quick Reference by Feature](#quick-reference-by-feature)
  - [File Magic Analysis](#file-magic-analysis)
  - [Authentication](#authentication-1)
  - [Path Validation \& Security](#path-validation--security)
